...
const int numind=200; // el tamaño de la poblacion de individuos, usar 500 en la solucion con Algoritmos Geneticos
...
const double pc = 0;// original: 0.80
const double pm = 0;// original: 0.005
